...
function QuizComponent() {
  ...
  const handleNext = () => {
    ...
    const chosenOption = currentQuestion.data.options.find((o) => o.id === selectedOption)
      ...
      <div className="w-full max-w-2xl relative z-10">
        ...
        <div className="bg-card/90 backdrop-blur-lg border-x border-border p-6 shadow-lg">
          <AnimatePresence mode="wait">
            ...
            >
              {/* Question */}
              <h2 className="text-xl font-bold text-text mb-4">{currentQuestion.data.text}</h2>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <p
                        className={`text-sm transition-colors ${
                          selectedOption === option.id ? "text-primary font-medium" : "text-text"
                        }`}
                      >
                        {option.text}
                      </p>
